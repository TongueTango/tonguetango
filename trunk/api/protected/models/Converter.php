...
abstract class Converter
{
	 ...
	 * @var string
	 */
	//private static $_ffmpeg_command	= '/usr/local/bin/ffmpeg -loop  1 -shortest -y -i  %1$s -i %2$s -r 1 %3$s';
	private static $_ffmpeg_command1	= 'ffmpeg -loop 1 -i %1$s -i %2$s -vcodec mpeg4 -acodec copy -shortest -qscale 5 %3$s';
