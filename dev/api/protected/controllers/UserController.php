...
class UserController extends Controller
{
    ...
    public function actionLogin()
    {
        ...
        if( array_key_exists('facebook_access_token', $data) && $data['facebook_access_token'] != '' ) {
            ...
            $this->_sendResponse(200, array("data" => $data, "code"=>'0','message'=>'No usable account identification available, please pass facebook token or username and password!'));
        }
        if( !$user ){
    ...
    public function actionUpdate()
    {
        ...
        if( is_array($file) && array_key_exists('name', $file) ) { 
            ...
            $fileName = (string)date("U").$file['name'];
