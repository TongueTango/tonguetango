...
class ContactController extends Controller
{
    ...
    public function confirm_contact( $data ){
        if( isset( $data["contact_id"] ) ) {
            ...
            $devices = Devices::model()->findAll( array('condition' => 'push_token!="" AND push_token!=NULL AND user_id=' . $requestor->id ) );
    ...
    public function request_contact( $data ) {
        ...
        $devices = Devices::model()->findAll( array('condition' => 'push_token!="" AND push_token!=NULL AND user_id=' . $user->id ) );
